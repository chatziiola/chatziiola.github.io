#+TITLE: Sigh...Hasta La Vista: THM: Skynet
#+DATE: <2023-12-15 11:32>
#+DESCRIPTION: 
#+FILETAGS: 

Yesterday I lost the opportunity to use "I'll be back" on my post's
title. Unfortunate but I had not see ~Skynet~ in the list of my TODO
rooms.
...
Whih, in turn, gave us some directories to check:
#+begin_example
/.htaccess (Status: 403)
/.htpasswd (Status: 403)
/admin (Status: 301)
...
** Samba enumeration
Just from what we have seen already, we do not have any credentials or
...
Visiting ~/admiinistrator~ we get to a login page of *CuppaCMS*:
...
2. PHP injection potential (a reverse shell might be nice as well)
