...
Since I last updated this section, quite a lot of stuff went on:
- Got back on track with TryHackMe, not only completing learning
  paths, but also taking on more difficult challenges. It feels nice
  seeing myself improve step by step
- Dealt with my fair share of homework on different courses (and it is
  not over yet)
- Found some time to read some extra-curriculum books too (a couple of
  them being technical, but I also caught up with "The Name Of The
  Rose", and I'll try to finish it this time :P)

Strangely, it feels like a messy period, but one that has potential.
